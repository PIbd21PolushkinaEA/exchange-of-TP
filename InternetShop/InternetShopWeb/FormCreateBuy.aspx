<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormCreateBuy.aspx.cs" Inherits="InternetShopWeb.FormProduct" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            Товар &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
        <asp:DropDownList ID="DropDownListProduct" runat="server" Height="16px" Width="285px">
        </asp:DropDownList>
            <br />
            <br />
            Количество&nbsp;&nbsp;
